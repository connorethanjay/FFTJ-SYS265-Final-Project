...
| [ ] | Deploy a new app to Util using Ansible (not covered in class). | [Video](https://drive.google.com/file/d/1JeC6UQ6-x5AxZO9ihbVh9ZulLWG8RLda/view?usp=sharing) |
...
| [ ] | Use Ansible to add a new Windows domain user. | [Video](https://drive.google.com/file/d/1QgVBlr30mTOAaFpeeIZ4iJDaTvvfFi_k/view?usp=sharing) |
